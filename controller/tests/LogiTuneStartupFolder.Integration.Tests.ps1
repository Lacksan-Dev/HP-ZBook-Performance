Describe 'EXP-117 LogiTuneStartupFolder zero-mutation integration' -Tag 'Integration' {
    BeforeAll {
        ...
        $provider = Join-Path $PSScriptRoot '..\providers\LogiTuneStartupFolder.ps1'
        $script:state = Join-Path $TestDrive 'exp117-state.json'
        $script:log = Join-Path $TestDrive 'exp117-events.jsonl'
