...
Describe 'LogiOptionsPlusDemandLaunch contract' {
    ...
    It 'preserves protected applications and Windows controls' {
        foreach($token in 'omnissa','windows app','remote desktop','tailscale','defender','windows update','recovery'){ $text | Should -Match $token }
    }
