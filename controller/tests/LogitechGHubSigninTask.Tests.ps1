...
Describe 'EXP-091 LogitechGHubSigninTask provider contract' {
 ...
 It 'captures exact task and executable evidence'{foreach($t in 'Xml','XmlSha256','DefinitionSha256','TriggersXml','SettingsXml','RegistrationInfoXml','TaskName','TaskPath','Author','Principal','Arguments','WorkingDirectory','Sha256','FileVersion','Publisher','Thumbprint','LastRunTime','LastTaskResult','NextRunTime','capturedBootTime'){$text|Should -Match $t}}
