Describe 'EXP-050 LogiOptionsPlusDemandLaunch zero-mutation integration' -Tag 'WindowsIntegration' {
 BeforeAll {
  $script:providerPath = Join-Path $PSScriptRoot '..\providers\LogiOptionsPlusDemandLaunch.ps1'
