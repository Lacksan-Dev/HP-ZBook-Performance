...
$required=@('DisableHardwareAcceleration','DryRun','VerifyReboot','Rollback','ShouldProcess','state-captured','reboot-verified','rolled-back','Enterprise Office policy controls')
...
[pscustomobject]@{experiment='EXP-028';parse='pass';contract='pass';destructiveActions='absent'}
